...
<section id="mainContent" class="clear">
    ...
    <section id="mainRight">
        <h1>Estadisticas</h1>
        <div>
            <g:form controller="receta" action="estadisticas">
				<select name="estadistica"> 
                 <option value="masVisto">Mas consultados</option>                 
                </select>
            <g:submitButton name="submit">Aceptar</g:submitButton>
            </g:form>
        </div>
        <div>
